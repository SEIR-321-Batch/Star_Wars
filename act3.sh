...
# HINT: * following a directory will grab all files/folders inside of a directory (directory/*)
mv star_wars/empire/death_star/millenium_falcon/*.txt star_wars/empire/death_star 
