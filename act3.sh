...
mv luke_skywalker.txt princess_leia.txt obi_won /Users/luis/sei321/labs/star_wars/star_wars/empire/death_star
...
mv luke_skywalker.txt princess_leia.txt /Users/luis/sei321/labs/star_wars/star_wars/empire/death_star/millenium_falcon

# 4. Move the millenium_falcon back into the rebellion directory.
mv millenium_falcon /Users/luis/sei321/labs/star_wars/star_wars/rebellion

# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader /Users/luis/sei321/labs/star_wars/star_wars/empire 
