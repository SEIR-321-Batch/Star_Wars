...
mv chewbacca.txt han_solo.txt luke_skywalker.txt princess_leia.txt ~/sei/deliverables/Star_Wars/Star_Wars/star_wars/empire/death_star/millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv millenium_falcon/ ~/sei/deliverables/Star_Wars/Star_Wars/star_wars/rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt ~/sei/deliverables/Star_Wars/Star_Wars/star_wars/empire
