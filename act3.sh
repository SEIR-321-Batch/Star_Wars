...
mv han_solo.txtvluke_skywalker.txt obi_wan.txt princess_leia.txt death_star
...
mv mv han_solo.txtvluke_skywalker.txt obi_wan.txt princess_leia.txt millenium_falcon
