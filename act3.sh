...
mv ~/millenium_falcon/chewbacca.txt ~/death_star
mv ~/millenium_falcon/luke_skywalker.txt ~/death_star
mv ~/millenium_falcon/princess_leia.txt ~/death_star
mv ~/millenium_falcon/obi_wan.txt ~/death_star
mv ~/millenium_falcon/han_solo.txt ~/death_star
...
mv ~/death_star/chewbacca.txt ~/millenium_falcon
mv ~/death_star/princess_leia.txt ~/millenium_falcon
mv ~/death_star/luke_skywalker.txt ~/millenium_falcon
mv ~/death_star/han_solo.txt ~/millenium_falcon
