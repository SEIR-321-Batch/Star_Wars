...
mv millennium_falcon death_star
...
mv emperor_palpatine.txt death_star/millenium_falcon ; mv darth_vader.txt millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv ~/sei/deliverables/Star_Wars/star_wars/empire/death_star/millenium_falcon rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv rebellion/millenium_falcon/darth_vader.txt empire 
