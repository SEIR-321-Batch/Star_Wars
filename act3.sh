...
➜  empire git:(master) ✗ mv death_star/darth_vader.txt empire
// had to rename empire to darth_vader because when I moved darth_vader it changed the name to empire //
➜  empire git:(master) ✗ ..
➜  star_wars git:(master) ✗ mv empire/empire empire/darth_vader.txt
