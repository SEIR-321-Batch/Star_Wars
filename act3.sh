...
mv millenium_falcon/* ~/sei/deliverables/Star_Wars/star_wars/empire/death_star
...
mv chewbacca.txt millenium_falco
...
mv death_star/millenium_falcon ~/sei/deliverables/Star_Wars/star_wars/rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt ~/sei/deliverables/Star_Wars/star_wars/empire
