...
# 5. Inside the millenium_falcon, create two files: c and chewbacca.txt
touch c chewbacca.txt
# 6. Move luke_skywalker, obi_wan, and princess_leia into the millenium_falcon, respectively.
mv luke_skywalker obi_wan princess_leia.txt /Users/luis/sei321/labs/star_wars/star_wars/rebellion/millenium_falcon
# 7. Move the millenium_falcon into the death_star.
mv millenium_falcon /Users/luis/sei321/labs/star_wars/star_wars/empire/death_star
