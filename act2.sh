...
cd rebellion && touch princess_leia.txt && echo "Help me, Obi_Wan...Your're my only hope." > princess_leia.txt
...
mv millenium_falcon ~/Desktop/GA/sei/deliverables/Starwar/Star_Wars/empire/death_star