...
cd rebellion && touch princess_leia.txt && echo "Help me, Obi-wan...You're my only hope." > princess_leia.txt
...
mv millenium_falcon ~/sei/deliverables/star/Star_Wars/empire/death_star