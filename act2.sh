...
cd star_wars/rebellion && touch princess_leia.txt && echo "Help me, Obi-Wan... You're my only hope." >> princess_leia.txt
...
mv ../millenium_falcon ~/sei/deliverables/star-wars-cli/Star_Wars/star_wars/empire/death_star 
