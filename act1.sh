...
mkdir star_wars
# 2. In the star_wars folder, create two new directories: empire and rebellion (This can be done in two commands, but how would you do it in one?) mkdir Empire Rebellion 
...
echo darth_vader.txt "...heavy on the breathing..."
...
# 7. Move darth_vader.txt into the death_starT
